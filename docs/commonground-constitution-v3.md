...
2. **Between Tier 1 principles,** Revocability (1), Due Process (2), Forkability (4), Holonic Nesting (5), and Deliberation (6) are co-equal. Conflicts between them are resolved through deliberation with special attention to all affected principles.
