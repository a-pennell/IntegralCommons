  ...
  return (
    ...
    >
      ...
      <section className="border-t border-[color:var(--color-rule-strong)] pt-8">
        ...
        <p className="mb-3 max-w-prose text-(length:--text-body) leading-(--text-body--line-height) font-[var(--font-body)] text-[color:var(--color-ink)]">
          A complete export of all Space data requires a Decision Record that authorises the export.
          Open a governance issue, drive it to a Decision Record that includes the authorisation,
          then return here with the Decision Record ID.
        </p>
        <p className="max-w-prose text-(length:--text-small) leading-(--text-small--line-height) font-[var(--font-body)] text-[color:var(--color-muted)] italic">
