  ...
  return (
    <div className="rounded-lg border border-[color:var(--color-rule)] bg-[color:var(--color-paper-soft)]">
      <div className="flex items-center gap-2 border-b border-[color:var(--color-rule)] px-3 py-2">
        <span className="text-[11px] font-[var(--font-display)] font-semibold uppercase tracking-widest text-[color:var(--color-muted)]">
          {data.label}
        </span>
        <span className="font-[var(--font-mono)] text-[10px] text-[color:var(--color-muted)]">
          {data.count}
        </span>
      </div>
    </div>
